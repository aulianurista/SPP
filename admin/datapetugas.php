...
<nav>
    ...
    <h4 class="hide">Navigasi</h4>
      ...
      <li class="tooltip-element" data-tooltip="1">
        ...
        <li class="tooltip-element" data-tooltip="0" class="ac">
          <a href="datapetugas.php" class="active" data-active="0">
            <div class="icon">
...
<!--    </div>-->
  ...
  <form  action="search/searchpet.php" method="get" class="search">
                  <input type="text"  name="cari" placeholder="Cari Petugas">
                </form>
  <?php
        include "koneksi.php";
        global $conn;
...
while($histori = mysqli_fetch_array($his)){
    $no++;
    $hapus="<td>"."<a href='hapus.php?id_petugas=".$histori['id_petugas']."' onclick='return confirm(\"Apakah anda yakin menghapus data ini?\")' class='button-hapus'>Hapus</a>"."</td>";
    $ubah="<td>"."<a href='ubah_petugas.php?id_petugas=".$histori['id_petugas']."'  class='button-ubah'>Ubah</a>"."</td>";
...
<a href="tambah_petugas.php" class="button-tambah">+ Tambah Petugas</a>
<?php
      }
