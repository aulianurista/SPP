...
<nav>
    ...
    <h4 class="hide">Navigasi</h4>
      ...
      <li class="tooltip-element" data-tooltip="1">
        ...
        <li class="tooltip-element" data-tooltip="0" class="ac">
          <a href="datakelas.php" class="active" data-active="0">
            <div class="icon">
...
while($histori = mysqli_fetch_array($his)){
    ...
    $no++;
    $hapus="<td>"."<a href='hapus.php?id_kelas=".$histori['id_kelas']."' onclick='return confirm(\"Apakah anda yakin menghapus data ini?\")' class='button-hapus'>Hapus</a>"."</td>";
    $ubah="<td>"."<a href='ubah_kelas.php?id_kelas=".$histori['id_kelas']."'  class='button-ubah'>Ubah</a>"."</td>";
