  ...
  <?php
      ...
      // var_dump($row);
       if($row==0){
        ...
        echo "<a href='tambah_angkatan.php' class='button-tambah2'>+Tambah Data</a>";
      }elseif($row >0){
?>
...
while($histori = mysqli_fetch_array($his)){
    $no++;
    $hapus="<td>"."<a href='hapus.php?id_angkatan=".$histori['id_angkatan']."' onclick='return confirm(\"Apakah anda yakin menghapus data ini?\")' class='button-hapus'>Hapus</a>"."</td>";
    $ubah="<td>"."<a href='ubah_angkatan.php?id_angkatan=".$histori['id_angkatan']."'  class='button-ubah'>Ubah</a>"."</td>";
